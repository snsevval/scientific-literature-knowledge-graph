...
5. NEVER join unnecessary nodes — use simple 2-node patterns only
6. Use CONTAINS instead of = for property name matching
7. Example: MATCH (m:Material)-[:HAS_PROPERTY]->(p:Property) WHERE toLower(p.name) CONTAINS 'superconductiv' RETURN m.name, p.name LIMIT 20
